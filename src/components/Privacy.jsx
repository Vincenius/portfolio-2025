...
const Privacy = ({ activePath }) => {
  return <Layout activePath={activePath}>
    ...
    <p>
      If you think I&apos;m missing something here - please let me know: hello@vincentwill.com
    </p>
    ...
    <p>Updated date: April 10, 2026</p>
    <p>
    ...
    <ul>
      <li>By email: hello@vincentwill.com</li>
    </ul>
  </Layout>
}
